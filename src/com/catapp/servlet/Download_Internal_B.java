...
// =================== assays with multiple phenotypes: 
		...
		int N_selected_multi_ph_assays = selected_multi_ph_assays.size();
		System.out.println("N_selected_multi_ph_assays = " + N_selected_multi_ph_assays); 
...
// =================== all assays ========================: 		
		...
		if (N_selected_multi_ph_assays == 0){
	       	 System.out.println("selected_multi_ph_assays: 0");
