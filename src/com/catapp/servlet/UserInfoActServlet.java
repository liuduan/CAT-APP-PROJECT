...
/**
 * Servlet implementation class UserInfoActServlet
 */
@WebServlet("/UserInfoActServlet")
public class UserInfoActServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserInfoActServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/WEB-INF/UserInfoAct.jsp").forward(request, response);
	}
