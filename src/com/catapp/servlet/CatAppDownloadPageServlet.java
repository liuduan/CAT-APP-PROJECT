...
public class CatAppDownloadPageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)  
		...
		System.out.println("CatAppDownloadPageServlet A");
		...
		try{
			...
			System.out.println("CatAppDownloadPageServlet B");
			...
			System.out.println("CatAppDownloadPageServlet C");
			...
			System.out.println("CatAppDownloadPageServlet D");
			
			if(session!=null){
				System.out.println("CatAppDownloadPageServlet E");
