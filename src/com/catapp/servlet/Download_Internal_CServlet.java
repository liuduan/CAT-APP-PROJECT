...
public class Download_Internal_CServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Download_Internal_C servlet: ");
		
		
		ArrayList<String> England_assays = new ArrayList<>(Arrays.asList(				
		...
		ArrayList<String> selected_England_assays = new ArrayList<String>();
		for(int x = 0; x < 55; x = x + 1) {
	         // System.out.println("cell lines: "+ cell_lines.get(x));
	         String received_value = request.getParameter(England_assays.get(x));	// receiving the post value
	         if (received_value != null){
	        	 System.out.println("selected_England_assays: "+ received_value);
	        	 selected_England_assays.add(received_value);
	         }
	      }
		...
		ArrayList<String> all_phenos = new ArrayList<>(Arrays.asList(			
			...
			"CM_Ca2_SEQ",  "CM_Hoechst_TC", "CM_Hoechst_NMA", "CM_Hoechst_SEQ",  "CM_Mito_posMT", "CM_Mito_MSA", 			
			"CM_Mito_ACMA", "CM_Mito_SEQ",  		
			
			"HEP_Hoechst_TC", 	"HEP_Hoechst_NI", "HEP_Hoechst_NMA", "HEP_Hoechst_SEQ",  "HEP_Mito_posMT",
			"HEP_Mito_MSA", "HEP_Mito_ACMA", "HEP_Mito_SEQ",  	
			
			"ENDO_Hoechst_TC", "ENDO_Hoechst_NI", 	"ENDO_Hoechst_NMA", "ENDO_Mito_SEQ",  "ENDO_Mito_MSA", 
			...
			"HUV_Mito_MSA", "HUV_Mito_ACMA", "HUV_Mito_SEQ", "HUV_TubForm_TTL", "HUV_TubForm_MTL", 
			...
			"Neur_Mito_MSA", "Neur_Mito_ACMA", "Neur_Mito_SEQ", "Neur_NeurOut_TotOut", "Neur_NeurOut_MeOutCe", 
			...
			"Macr_Mito_MSA", "Macr_Mito_ACMA", "Macr_Mito_SEQ",  "Macr_Phag_PhagCe", "Macr_Phag_PhagAr", 
