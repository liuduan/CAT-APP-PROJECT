				...
				<div id="myModal" class="modal fade" role="dialog">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text" >
                            <h1><strong>UPLOAD</strong> Files in Analytical Data</h1>
                            <div class="description">
                            	<p>
	                            	Give us ConcaweID,SampleID and CasNumber and you are <strong>good</strong> to go!
                            	</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box" style="margin-top:-50px">
                        	...
                        	<form role="form" action="SaveAndValidateConcaweData" method="post" class="registration-form" enctype="multipart/form-data">
                        		
                        		<fieldset>
		                        	<div class="form-top ">
		                        		<div class="form-top-left">
		                        			<h3>Step 1 / 4:</h3> <h4>Input ConcaweID</h4>
		                            		<!-- <h4>Cell Type:</h4><p>Somewhere to Start &#9786;</p> -->
		                            		<div class="progress">
										  <div class="progress-bar progress-bar-warning progress-bar-striped" role="progressbar"
										  aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width:35%">
										    0%(start)
										  </div>
										</div>
		                            ...
		                            <div class="form-bottom scrollable ">
    									...
    									<input type="radio" name= "concawe" id= <c:out value="${concawe.value}"/> value= <c:out value="${concawe.key}"/>> &nbsp;<b><c:out value="${concawe.value}"/></b><br><br>
			                    ...
			                    <fieldset id="step2">
		                        	<div class="form-top">
		                        		<div class="form-top-left">
										  ...
										  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width:35%">
										    25% Complete
										  </div>
		                            ...
		                            <div class="form-bottom scrollable">
				                        <div class="form-group">
				                        	<label class="sr-only" for="form-email">CAS NUMBERS</label>
				                        	 ...
				                        	 <c:forEach var="casnames" items="${cas}">
    												...
    												<input type="radio" name= "casnames" id= <c:out value="${casnames.value}"/> value= <c:out value="${casnames.key}"/>> &nbsp;<b><c:out value="${casnames.value}"/></b><br><br>
				                        ...
				                        <button type="button" class="btn btn-next" id="casnext" onClick="matchCasNumbers()">Next</button>
				                         <!-- OR
								  ...
								  <div>   
		                            ...
		                            <div class="form-bottom">
				                       <div class="form-group">
										...
										<button type="button" class="btn btn-previous">Previous</button>
				                     	 <button type="submit" name="submitbutton" id="save" value ="save" class="btn btn-submit" >Upload</button>
