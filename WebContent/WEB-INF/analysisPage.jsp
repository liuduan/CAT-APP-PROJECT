...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="/CAT-APP-PROJECT/resources/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<jsp:include page="headerUserHome.jsp" /> 
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar pre scrollable pre-scrollable" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" id="chemsearch" onkeyup="filterchem()" placeholder="Search Chemicals...">
                        ...
                        <li class="chemical">
                       &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name= "chemicals" id= "chemicals" value= <c:out value="${chemicals.key}"/>> &nbsp;<c:out value="${chemicals.value}"/>
						...
						<div id="accordion1" role="tablist" aria-multiselectable="true" >
									  <div class="card">
										<div class="card-header" role="tab" id="headingOne">
										  <h5 class="mb-0">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="first" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
											 Click to Expand
											</a>
										  </h5>
										</div>
                            ...
                            <div class="panel-footer collapseOne collapse"id="collapseOne" aria-labelledby="headingOne">
							
								<div class="card-block" id="cellline">
											  <c:forEach var="cellline" items="${cell}">
											<span class="text-nowrap"> <input type="radio" name= "celllineinput" 
    												id= <c:out value="${cellline.value}"/> 
    												value= <c:out value="${cellline.key}"/>> 
    												&nbsp;<c:out value="${cellline.value}"/></span><br>
                    ...
                    <div class="panel panel-green">
						...
						<div id="accordion2" role="tablist" aria-multiselectable="true">
									  <div class="card">
										<div class="card-header" role="tab" id="headingOne">
										  <h5 class="mb-0">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a data-toggle="collapse" data-parent="#accordion2" href="#collapseOne1" aria-expanded="true" aria-controls="collapseOne">
											 Click to Expand
											</a>
										  </h5>
										</div>
                            ...
                            <div class="panel-footer collapseOne collapse"id="collapseOne1"  aria-labelledby="headingOne">
								...
								<div class="card-block" id="assays">
											  <c:forEach var="assays" items="${assay}">
											 	<c:choose>
											  	...
											  	<c:otherwise>
											  	<span class="text-nowrap"><input type="radio" name= "assayinput" 
    												id= <c:out value="${assays.value}"/> 
    												value= <c:out value="${assays.key}"/>> 
    												&nbsp;<c:out value="${assays.value}"/></span><br> 
											  	</c:otherwise>
											  	</c:choose>
                        ...
                        <div class="panel-heading">
                            ...
                            <div id="accordion3" role="tablist" aria-multiselectable="true">
									  <div class="card">
										<div class="card-header" role="tab" id="headingOne">
										  <h5 class="mb-0">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a data-toggle="collapse" data-parent="#accordion3" href="#collapseOne2" aria-expanded="true" aria-controls="collapseOne2">
											 Click to Expand
											</a>
										  </h5>
										</div>
                            ...
                            <div class="panel-footer collapseOne collapse"id="collapseOne2"aria-labelledby="headingOne">
								...
								<div class="card-block" id="phenotypes" >
											   ...
											   <c:choose>
											  	...
											  	<c:otherwise>
											  	<span class="text-nowrap"><input type="radio" name= "phenotypeinput" 
    												id= <c:out value="${phenotypes.value}"/> 
    												value= <c:out value="${phenotypes.key}"/>> 
    												&nbsp;<c:out value="${phenotypes.value}"/></span><br>
											  	</c:otherwise>
											  	</c:choose>	
											  </c:forEach>
								</div>
